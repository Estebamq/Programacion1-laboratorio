...
void mostrarLocalidades(eLocalidad [],int);
void mostrarLocalidadesConAlumnos(eAlumno[],int,eLocalidad[],int);
void mostrarAlumnosDeAvellaneda(eAlumno[],int,eLocalidad[],int);
void mostrarLocalidadConMenosAlumnos(eAlumno[],int,eLocalidad[],int);
